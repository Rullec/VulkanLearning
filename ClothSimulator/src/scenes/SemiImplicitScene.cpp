...
tVectorXd cSemiImplicitScene::CalcNextPositionImplicit()
{
    /*
...
*/
void cSemiImplicitScene::CalcGxImplicit(const tVectorXd &x, tVectorXd &Gx,
...
*/
void cSemiImplicitScene::CalcdGxdxImplicit(const tVectorXd &x, tMatrixXd &dGdx) const
{
...
*/
void cSemiImplicitScene::TestdGxdxImplicit(const tVectorXd &x0, const tMatrixXd &Gx_ana)
{
    double eps = 1e-6;
...
void cSemiImplicitScene::CalcdGxdxImplicitSparse(const tVectorXd &x,
...
*/
void cSemiImplicitScene::CalcDampingForce(const tVectorXd &vel, tVectorXd &damping) const
{
...
tVectorXd cSemiImplicitScene::CalcNextPositionOptImplicit() const
{
...
int cSemiImplicitScene::GetNumOfSprings() const { return mEdgeArray.size(); }