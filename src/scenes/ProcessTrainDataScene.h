...
protected:
    ...
    int mWidth, mHeight;
    tVector mCameraPos, mCameraCenter, mCameraUp; // camera position, center point and up direction
    ...
    void CalcDepthMap(
        ...
        const std::string raw_data_path, const std::string &save_png_path, const std::string &json_path, CameraBasePtr camera);
