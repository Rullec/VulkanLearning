...
class CNNParamNet(ParamNet):
    ...
    def _build_net(self):
        ...
        # exit(0)
        # from multiview_net import MultiviewNet
        # self.net = MultiviewNet(4, self.output_size).to(self.device)
        # -----------------------
        # from vgg16_backbone_core import Vgg16
        # self.net = Vgg16(4, self.output_size).to(self.device)
